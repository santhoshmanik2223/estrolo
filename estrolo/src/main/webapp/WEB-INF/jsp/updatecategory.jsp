...
<body style="text-align: center;">
	<div class="container">
		...
		<spring:url value="/categories/saveCategory" var="updateURL" />
		<form:form modelAttribute="categoryForm" method="post"
			enctype="multipart/form-data" action="${updateURL }" cssClass="form">
			...
			<div class="form-group">
				...
				<div class="form-group">
					...
					<form:checkbox path="isParent" cssClass="form-control"
						id="isParent" />
				</div>
			...
			<div class="form-group">
				...
				<form:input type="file" path="image" id="image" size="50"
